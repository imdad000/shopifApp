...
from Allorder.views import create_product,customer_detail,cutomer_page,edit_customer,edit_customer_page,webhook_call,get_order
urlpatterns = [
	url(r'^$', home_page),
